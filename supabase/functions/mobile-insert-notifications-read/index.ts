...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.log("=== CREATE APPOINTMENT NOTIFICATION ===");
    ...
    console.log("Step 2: Creating notification for new appointment");

    const message = `New appointment booked for patient ${appointment.patients.name_en} on ${appointment.appointment_date}`;
    ...
    console.error("Error in mobile-insert-notifications-read:", error);
    return new Response(
      JSON.stringify({
