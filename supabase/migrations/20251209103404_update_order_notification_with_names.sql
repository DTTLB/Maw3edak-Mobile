/*
  # Update Order Notification with Patient and Doctor Names

  1. Changes
    - Update the `notify_new_order()` function to include:
      - Patient's first name
      - Doctor's name
      - Order description
    - Personalize the notification message format: "Dear [Patient Name], you have a new order from your doctor [Doctor Name]: [Order Description]"
